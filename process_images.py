...
def __main__():
    ...
    data_dir, pattern_fov, res, unet_predict_tf, post_process_tf, variation_parameters, pattern_predict, network_file = read_cfg_img_proc(filename)

    #This runs U-Net and/or post-processing with the configuration in the config.ini (or other specified name)
    high_throughput_multicore(test_image_dir = data_dir, pattern_fov = pattern_fov, 
